...
Moon::Moon(Graphics* renderer) : Object(renderer),
...
void Moon::Draw(ComPtr<ID3D12GraphicsCommandList> m_commandList, XMFLOAT4X4 viewproj, XMFLOAT4 eye)
{
