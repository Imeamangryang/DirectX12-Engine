...
Achates::Achates(Graphics* renderer) : Object(renderer),
	m_srvHeap(nullptr),
...
void Achates::Draw(ComPtr<ID3D12GraphicsCommandList> m_commandList, XMFLOAT4X4 viewproj, XMFLOAT4 eye)
{
...
void Achates::ClearUnusedUploadBuffersAfterInit()
{
	if (m_uploadHeap)
	{
...
void Achates::CreateDescriptorHeap(Graphics* Renderer)
{
	...
	LoadWICTextureFromFileEx(Renderer->GetDevice().Get(), L"models/Achates/textures/mn_rpat_00_d.png", 0, D3D12_RESOURCE_FLAG_NONE, WIC_LOADER_FORCE_RGBA32, &BumpColor, BumpColordecodeData, BumpColorMapData);
	...
	LoadWICTextureFromFileEx(Renderer->GetDevice().Get(), L"models/Achates/textures/mn_rpat_00_n.png", 0, D3D12_RESOURCE_FLAG_NONE, WIC_LOADER_FORCE_RGBA32, &normalMap, normalMapdecodeData, normalMapData);
...
void Achates::CreateConstantBuffer(Graphics* Renderer)
{
