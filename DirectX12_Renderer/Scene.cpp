	...
	ImGui::NewFrame();
	{
		...
		if (!ImGui::CollapsingHeader("Objects")) {
			if (ImGui::TreeNode(m_cube.m_objectname.c_str())) {
				...
				ImGui::InputInt("Edge Tessellation Factor1", &m_cube.m_edgetesFactor1);
				ImGui::InputInt("Edge Tessellation Factor2", &m_cube.m_edgetesFactor2);
				ImGui::InputInt("Edge Tessellation Factor3", &m_cube.m_edgetesFactor3);
				ImGui::InputInt("Inside Tessellation Factor", &m_cube.m_insidetesFactor);
			...
			if (ImGui::TreeNode(m_dragon.m_objectname.c_str())) {
				...
				ImGui::InputInt("Edge Tessellation Factor1", &m_dragon.m_edgetesFactor1);
				ImGui::InputInt("Edge Tessellation Factor2", &m_dragon.m_edgetesFactor2);
				ImGui::InputInt("Edge Tessellation Factor3", &m_dragon.m_edgetesFactor3);
				ImGui::InputInt("Inside Tessellation Factor", &m_dragon.m_insidetesFactor);
